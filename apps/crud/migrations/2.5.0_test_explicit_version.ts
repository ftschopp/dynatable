...
/**
 * Migration: test_explicit_version
 * Version: 2.5.0
 *
 * Description:
...
export const migration: Migration = {
  ...
  async up({ client, tableName, dynamodb }) {
    console.log('Running migration: test_explicit_version');
  ...
  async down({ client, tableName, dynamodb }) {
    console.log('Rolling back migration: test_explicit_version');
